function [J grad] = dnn4CostFunction(nn_params, ...
                                   input_layer_size, ...
                                   hidden_layer_2_size, ...
                                   hidden_layer_3_size, ...
                                   hidden_layer_4_size, ...
...
% == STEP3 ===
Theta4_temp = Theta4(:,2:end);
delta_4 = (delta_5*Theta4_temp).*sigmoidGradient(z4);
...
Theta4_grad(:,2:end) = Theta4_grad(:,2:end) + s(:,2:end);
